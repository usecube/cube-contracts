...
import {IAaveV3Pool} from "./interfaces/protocol/IAaveV3Pool.sol";
import {IERC4626Vault} from "./interfaces/vaults/IERC4626Vault.sol";
 ...
 */
contract Vault is IERC4626Vault, ERC4626Upgradeable, OwnableUpgradeable {
